...
for process_id = PID_list
    ...
    thedoc = strcat("test_f0_timeonly_stationary_PID",num2str(process_id));
    ...
    thedoc = strcat("test_f0_timeonly_stationary_GLM_PID",num2str(process_id));
    ...
    thedoc = strcat("test_f0_timeonly_stationary_HPE_PID",num2str(process_id));
