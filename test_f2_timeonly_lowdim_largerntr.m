...
thedoc = "test_f2_timeonly_lowdim_largerntr";
...
if use_VI
    label = "VI";
    lr_schedule = [0.4*ones(20,1), 0.2*ones(20,1), 0.2*ones(20,1) ]/10;
else
    label = "GD";
    lr_schedule = [0.2*ones(20,1), 0.1*ones(20,1), 0.1*ones(20,1) ]/10;
end
