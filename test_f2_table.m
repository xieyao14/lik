function [table_show, table_full, report] = test_f2_table(options)
%TEST_F2_TABLE Aggregate paired replicas for the N=32, N'=8 experiment.
%
...
summary_path = string(table_option(options, "summary_path", ...
    fullfile(output_dir, "test_f2_table_summary.mat")));
...
artifact_specs = {
    1, column_names(1), "test_f2_timeonly_lowdim_replica_%02d_TULIK_VI_EstMuRelErr.mat",  "mu_rela_err",     "vector";
    2, column_names(2), "test_f2_timeonly_lowdim_replica_%02d_TULIK_GD_EstMuRelErr.mat",  "mu_rela_err",     "vector";
    3, column_names(3), "test_f2_timeonly_lowdim_replica_%02d_TULIK_VI_EstKerRelErr.mat", "kernel_rela_err", "vector";
    4, column_names(4), "test_f2_timeonly_lowdim_replica_%02d_TULIK_GD_EstKerRelErr.mat", "kernel_rela_err", "vector";
    5, column_names(5), "test_f2_timeonly_lowdim_replica_%02d_TULIK_VI_ProbPredErr.mat",  "proberror",       "prediction";
    6, column_names(6), "test_f2_timeonly_lowdim_replica_%02d_TULIK_GD_ProbPredErr.mat",  "proberror",       "prediction";
    7, column_names(7), "test_f2_timeonly_lowdim_replica_%02d_GLM_L_ProbPredErr.mat",     "proberror",       "prediction";
    8, column_names(8), "test_f2_timeonly_lowdim_replica_%02d_GLM_S_ProbPredErr.mat",     "proberror",       "prediction";
    9, column_names(9), "test_f2_timeonly_lowdim_replica_%02d_HPE_ProbPredErr.mat",       "proberror",       "prediction";
    };
...
if require_complete && status ~= "complete"
    error("TULIK:IncompleteTable1Inputs", ...
...
fprintf("Table 1 aggregation: %d/%d complete paired replicas.\n", ...
    report.num_complete, report.num_requested);
...
for norm_index = 1:3
    ...
    for column = 1:9
        ...
        std_value = "(" + sprintf("%.2f", ...
            table_show(std_row_index, column)) + ")";
