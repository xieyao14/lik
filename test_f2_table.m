...
for process_id = PID_list
    ...
    thedoc = strcat("test_f2_timeonly_lowhdim_PID",num2str(process_id));
    ...
    thedoc = strcat("test_f2_timeonly_lowhdim_GLM_PID",num2str(process_id));
    ...
    thedoc = strcat("test_f2_timeonly_lowdim_HPE_PID",num2str(process_id));
