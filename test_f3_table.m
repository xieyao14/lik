...
for process_id = PID_list
    ...
    thedoc = strcat("test_f3_graph",num2str(process_id));
    ...
    thedoc = strcat("test_f3_graph_GLM_PID",num2str(process_id));
    ...
    thedoc = strcat("test_f3_graph_HPE_PID",num2str(process_id));
